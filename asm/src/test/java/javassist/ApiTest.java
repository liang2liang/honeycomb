...
public class ApiTest {
    ...
    public static void main(String[] args) throws InterruptedException, NotFoundException, CannotCompileException, IOException, IllegalConnectorArgumentsException {
